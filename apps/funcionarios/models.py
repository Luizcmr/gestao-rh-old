...
class Funcionario(models.Model):
    ...
    ctps = models.CharField(max_length=15, help_text="CTPS", null=True, blank=True )
    ctps_rural = models.CharField(max_length=15, help_text="CTPS Rural", null=True, blank=True)
    titulo = models.CharField(max_length=15, help_text="Título de Eleitor", null=True, blank=True)
